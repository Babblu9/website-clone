...
export const metadata = {
  title: 'Diploma | IIFD - Indian Institute of Fashion & Design',
  description: 'Diploma at IIFD - Best Fashion Designing College in India',
};
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center mt-[100px]">
      ...
      <p className="font-body text-[#54595F] max-w-2xl mx-auto text-[18px]">
        This page is currently under construction. Please check back later for updates on the Diploma program and details.
      </p>
    </div>
  );
}
