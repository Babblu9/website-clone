...
import StudyAtIIFD from '@/components/sections/study-at-iifd';

export const metadata = {
  title: 'Training and Placement | IIFD - Indian Institute of Fashion & Design',
  description: 'IIFD Placement Team has exceptional connections within our industries and offers one on one targeted career planning and placement services.',
};
